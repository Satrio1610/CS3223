...
public class QueryMain {
	...
	public static void main(String[] args) {
		 ...
		 **/
		/**
		 * As buffer manager is not implemented, just input the number of buffers
		 * available
		 **/
		...
		/**
		 * This part is used When some random initial plan is required instead of comple
		 * optimized plan
		 **/
		/**
		 * 
		 ...
		 * pc.getCost(logicalroot); Debug.PPrint(logicalroot); System.out.print("
		 * "+initCost); System.out.println();
		 **/
		...
		RandomOptimizer ro = new RandomOptimizer_SimulatedAnnealing(sqlquery);
