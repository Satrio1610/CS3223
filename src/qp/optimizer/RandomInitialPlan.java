...
public class RandomInitialPlan {
    ...
    private Vector selectionlist;     //List of select conditons
    ...
    private Hashtable tab_op_hash;          //table name to the Operator
...
//            joinMeth = -1;
    ...
    private void createProjectOp() {
        ...
        if (isDistinct) {
            ...
            root = new ProjectDuplicateElimination(base, projectlist, OpType.PROJECTDUPLICATEELIMINATION, 0);
